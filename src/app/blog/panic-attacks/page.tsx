  ...
  return (
    <div className="min-h-screen bg-[#f8fbf9] text-[#064e3b]">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        <div className="mb-8">
          <span className="px-4 py-1.5 rounded-full bg-[#e6f4ea] text-[#064e3b] text-sm">Panic Attacks</span>
          <h1 className="text-6xl font-semibold tracking-tighter mt-6 mb-6">What to Do During a Panic Attack</h1>
          <p className="text-2xl text-[#047857]">A step-by-step, evidence-based guide</p>
        </div>
