      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="mb-10 flex flex-col md:flex-row items-center gap-8">
          <div>
            ...
            <p className="text-xl text-[#047857]">We built SoulSpace to be private by design. Here&apos;s exactly what that means.</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-[#047857]">Stored only on your device. We cannot see them.</div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-[#047857]">Stored only on your device. We cannot see it.</div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-[#047857]">Stored only on your device.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card p-8">
          ...
          <div className="space-y-4">
            <button 
              ...
              className="w-full flex items-center justify-between p-6 rounded-2xl bg-white shadow-xs border border-[#dcfce7] hover:bg-[#e6f4ea] text-[#064e3b] border border-[#dcfce7] transition-all"
            >
              <div className="flex items-center gap-4">
                <Download className="w-6 h-6 text-[#4ade80]" />
                <div className="text-left">
                  <div className="font-medium">Export my data</div>
                  <div className="text-sm text-[#475569]">Download everything stored on your device</div>
                </div>
              </div>
            </button>
            ...
            <button 
              ...
              className="w-full flex items-center justify-between p-6 rounded-2xl bg-white shadow-xs border border-[#dcfce7] hover:bg-[#f87171]/10 border border-[#dcfce7] hover:border-[#f87171]/30 transition-all"
            >
              <div className="flex items-center gap-4">
                <Trash2 className="w-6 h-6 text-[#f87171]" />
                <div className="text-left">
                  <div className="font-medium">Delete everything</div>
                  <div className="text-sm text-[#475569]">Permanently remove all your data from this device</div>
                </div>
              </div>
            </button>
          </div>
            ...
            {!dataDeleted ? (
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-[#047857]">This will permanently remove your check-ins, safety plan, and saved items from this device. This cannot be undone.</p>
                </div>
                <div className="flex gap-3">
                  <button onClick={() => setShowDeleteConfirm(false)} className="btn btn-secondary flex-1">Cancel</button>
                  <button onClick={handleDeleteAllData} className="btn flex-1 bg-[#f87171] hover:bg-[#ef4444] text-[#064e3b]">Yes, delete everything</button>
                </div>
              </>
            ) : (
              <div className="text-center py-4">
                <div className="text-[#4ade80] mb-4">✓ All data has been deleted from this device.</div>
                <p className="text-sm text-[#475569]">You can start fresh anytime.</p>
              </div>
            )}
          </div>
        </div>
